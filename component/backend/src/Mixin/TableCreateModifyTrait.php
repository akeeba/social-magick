...
/**
 * A Trait for MVC Table objects which handles the created and modified table properties for you.
 *
 * This is based on my prior work on FOF.
 *
 * @since  3.0.0
 */
trait TableCreateModifyTrait
{
	private bool $updateModified = true;

	private bool $updateCreated = true;
