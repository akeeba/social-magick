...
/**
 * A trait to abstract event calling across Joomla versions.
 *
 * Joomla has been steadily introducing concrete event classes since Joomla 4.0. However, our software runs across
 * multiple versions of Joomla, which have different sets of concrete classes. Using a concrete class on an older Joomla
 * version will cause a PHP error as the class doesn't exist.
 *
 * This trait gets rid of all the noise. You give it the event name, and it figures out the rest using the code I had
 * contributed to the Joomla core all those years ago ;)
 *
 * @since  3.0.0
 */
