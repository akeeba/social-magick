...
/**
 * An MVC Model for managing update actions.
 *
 * This is used to perform housekeeping every time you install or update the extension.
 *
 * @since   3.0.0
 */
...
class UpgradeModel extends BaseModel implements DatabaseAwareInterface
{
	 ...
	 * @var   string
	 */
	private const PACKAGE_NAME = 'pkg_socialmagick';
